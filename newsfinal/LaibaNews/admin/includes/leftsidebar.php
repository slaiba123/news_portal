...
<?php endif;?>
  ...
  <li class="has_sub">
    ...
    <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Surveys </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                  <li><a href="add-surveyques.php">Add Survey Questions </a></li>
                                    <li><a href="Manage-surveyques.php">Manage Survey </a></li>
                                    <li><a href="Report-survey.php">Survey Report </a></li>
                                </ul>
                            </li>                        
